...
const ORIGIN_AIRPORTS = [
  ["ABQ","Albuquerque"],["ALB","Albany"],["ANC","Anchorage"],["ATL","Atlanta"],
  ["AUS","Austin"],["BDL","Hartford"],["BHM","Birmingham"],["BNA","Nashville"],
  ["BOI","Boise"],["BOS","Boston"],["BUF","Buffalo"],["BUR","Burbank"],
  ["BWI","Baltimore"],["CHS","Charleston"],["CLE","Cleveland"],["CLT","Charlotte"],
  ["CMH","Columbus"],["CVG","Cincinnati"],["DAL","Dallas Love Field"],["DAY","Dayton"],
  ["DCA","Washington Reagan"],["DEN","Denver"],["DFW","Dallas/Fort Worth"],["DSM","Des Moines"],
  ["DTW","Detroit"],["ELP","El Paso"],["EWR","Newark"],["FLL","Fort Lauderdale"],
  ["GEG","Spokane"],["GRR","Grand Rapids"],["GSP","Greenville/Spartanburg"],["HNL","Honolulu"],
  ["HOU","Houston Hobby"],["IAD","Washington Dulles"],["IAH","Houston"],["IND","Indianapolis"],
  ["JAX","Jacksonville"],["JFK","New York JFK"],["LAS","Las Vegas"],["LAX","Los Angeles"],
  ["LGA","New York LaGuardia"],["MCI","Kansas City"],["MCO","Orlando"],["MDW","Chicago Midway"],
  ["MEM","Memphis"],["MHT","Manchester"],["MIA","Miami"],["MKE","Milwaukee"],
  ["MSP","Minneapolis"],["MSY","New Orleans"],["OAK","Oakland"],["OKC","Oklahoma City"],
  ["OMA","Omaha"],["ONT","Ontario"],["ORD","Chicago O'Hare"],["ORF","Norfolk"],
  ["PBI","West Palm Beach"],["PDX","Portland"],["PHL","Philadelphia"],["PHX","Phoenix"],
  ["PIT","Pittsburgh"],["PVD","Providence"],["RDU","Raleigh-Durham"],["RIC","Richmond"],
  ["RNO","Reno"],["ROC","Rochester"],["RSW","Fort Myers"],["SAN","San Diego"],
  ["SAT","San Antonio"],["SAV","Savannah"],["SDF","Louisville"],["SEA","Seattle"],
  ["SFO","San Francisco"],["SJC","San Jose"],["SLC","Salt Lake City"],["SMF","Sacramento"],
  ["SNA","Orange County"],["STL","St. Louis"],["SYR","Syracuse"],["TPA","Tampa"],
  ["TUL","Tulsa"],["TUS","Tucson"],
  ["YEG","Edmonton"],["YHZ","Halifax"],["YOW","Ottawa"],["YQB","Québec City"],
  ["YUL","Montreal"],["YVR","Vancouver"],["YWG","Winnipeg"],["YYC","Calgary"],
  ["YYJ","Victoria"],["YYZ","Toronto Pearson"],
];
